"""
Generates a larger synthetic history of maintenance requests, purely for
demonstrating the Section 13 analytics (hotspot clustering, anomaly detection).

This is clearly demo data, not real records -- it deliberately biases
Building 1 / Electrical issues to create a "hotspot," and inserts one
artificial spike day to demonstrate anomaly detection.

Run this AFTER create_db.py + populate_db.py + security_setup.py.
"""
import sqlite3
import random
